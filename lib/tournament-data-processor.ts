...
export class VolleyballDataProcessor {
  ...
  initializeRealData() {
    ...
    const tournament8Results: TournamentResult[] = [
      // 남자클럽 2부
      { tournament: "제4회단양도담삼봉배", division: "남자클럽 2부", teamName: "전남 LBT", rank: 1 },
      { tournament: "제4회단양도담삼봉배", division: "남자클럽 2부", teamName: "강릉 98즈", rank: 2 },
      ...
      { tournament: "제4회단양도담삼봉배", division: "여자클럽 3부", teamName: "서울 DMG", rank: 3 },
    ...
    const tournament12Results: TournamentResult[] = [
      ...
      // 남자 시니어부
      { tournament: "제61회 박계조배", division: "남자 시니어부", teamName: "고양 TEAM GP", rank: 1 },
    ...
    const tournament32Results: TournamentResult[] = [
      ...
      { teamName: "전남 LBT", division: "남자클럽 2부", rank: 2, tournament: "제14회 진안홍삼배 전국남여배구대회" },
      { teamName: "강릉 98즈", division: "남자클럽 2부", rank: 3, tournament: "제14회 진안홍삼배 전국남여배구대회" },
      {
        teamName: "고흥군 배구협회",
        division: "남자클럽 2부",
        rank: 3,
